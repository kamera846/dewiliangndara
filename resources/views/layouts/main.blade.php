                        ...
                        <div class="inner-container">
                            ...
                            <div class="logo-box">
                                <div class="logo">
                                    ...
                                    <a href="/"><h1 class="text-white">Liang Ndara</h1><p class="text-white">Desa Wisata</p></a>
                                </div>
                            </div>
                            <!--Nav Box-->
                            <div class="nav-outer">
                                ...
                                <nav class="main-menu navbar-expand-md navbar-light">
                                    <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                        <ul class="navigation">
                                            ...
                                            <li class="{{ ($judul_halaman === 'Tentang Kami | Desa Wisata Liang Ndara')?'current':'' }}"><a href="/about">Tentang Kami</a></li>
                                            <li class="{{ ($judul_halaman === 'Galeri | Desa Wisata Liang Ndara')?'current':'' }}"><a href="/gallery">Galeri</a></li>
                                            <li class="{{ ($judul_halaman === 'Blog | Desa Wisata Liang Ndara')?'current':'' }}"><a href="/blog">Blog</a></li>
                                            <li class="{{ ($judul_halaman === 'Kontak Kami | Desa Wisata Liang Ndara')?'current':'' }}"><a href="/contact">Kontak</a></li>
                                        </ul>
                                    </div>
                                </nav>
                            </div>
                ...
                <div class="mobile-menu">
                    ...
                    <nav class="menu-box">
                        <div class="nav-logo">
                            ...
                            <a href="/">Desa Wisata Liang Ndara</a>
                        </div>
                                    ...
                                    <div class="widget-content">
                                        <ul class="contact-info">
                                            <li>
                                                ...
                                                <div class="text">
                                                    <strong>Lokasi</strong>Melo,Desa Liang Ndara, Kecamatan Mbeliling <br />
                                                </div>
                                            </li>
                                            <li>
