    ...
    <div class="container pt-15 pt-md-17 pb-13 pb-md-15">
      ...
      <div class="swiper-container grid-view mb-6 swiper-container-0" data-margin="30" data-dots="true" data-items-xl="3" data-items-md="2" data-items-xs="1">
        <div class="swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
          <div class="swiper-wrapper" id="swiper-wrapper-38ece5f5e2c97e5d" aria-live="off" style="cursor: grab; transform: translate3d(-880px, 0px, 0px); transition-duration: 0ms;">
            <div class="swiper-slide" role="group" aria-label="1 / 6" style="width: 410px; margin-right: 30px;">
            ...
            <!--/.swiper-slide -->
            <div class="swiper-slide swiper-slide-prev" role="group" aria-label="2 / 6" style="width: 410px; margin-right: 30px;">
            ...
            <!--/.swiper-slide -->
            <div class="swiper-slide swiper-slide-active" style="width: 410px; margin-right: 30px;" role="group" aria-label="3 / 6">
            ...
            <!--/.swiper-slide -->
            <div class="swiper-slide swiper-slide-next" role="group" aria-label="4 / 6" style="width: 410px; margin-right: 30px;">
            ...
            <!--/.swiper-slide -->
            <div class="swiper-slide" role="group" aria-label="6 / 6" style="width: 410px; margin-right: 30px;">
